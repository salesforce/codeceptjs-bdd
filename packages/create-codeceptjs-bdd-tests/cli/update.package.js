...
exports.installDepedencies = () => {
    ...
    if (
        shell.exec(
            'yarn add prettier dotenv-extended codeceptjs-saucelabs@latest codeceptjs-configure@latest allure-commandline codeceptjs@2.6.10 debug faker playwright protractor rimraf should deepmerge soft-assert -D --registry https://registry.npmjs.org/'
        ).code !== 0
    ) {
